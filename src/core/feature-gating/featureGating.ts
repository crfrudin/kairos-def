...
/**
 * Helper para uso por UI/SSR: tenta habilitar, mas não redireciona nem decide UX.
 * (Mensagens/CTA ficam para ETAPA 5.4)
 */
export function requireFeature(snapshot: FeatureGatingSnapshot, feature: FeatureKey): { ok: true } | { ok: false } {
